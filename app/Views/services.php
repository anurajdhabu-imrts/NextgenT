        ...
        <div class="flex items-center justify-center text-center" data-aos="fade-up">
            <div class="max-w-3xl">
                ...
                <p class="text-base md:text-lg text-slate-300 leading-relaxed max-w-2xl mx-auto">
                    From greenfield project inception to day-to-day operational management, NextgenT Enterprises delivers a comprehensive suite of consulting and execution services tailored exclusively for the hospital and healthcare sector.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12" data-aos="fade-up">
            ...
            <p class="mt-3 text-slate-500 text-sm max-w-xl mx-auto leading-relaxed">
                Strategic solutions for hospital infrastructure, manpower, and revenue growth.
            </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-8">
            ...
            <div class="flex items-start gap-4 group" data-aos="fade-up" data-aos-delay="100">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500 leading-relaxed">Launch-ready brand identity, digital marketing frameworks, and market positioning for new hospital projects.</p>
                </div>
            </div>
            ...
            <div class="flex items-start gap-4 group" data-aos="fade-up" data-aos-delay="0">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500 leading-relaxed">Structured skill development programmes for clinical and non-clinical hospital staff to ensure service excellence.</p>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 mb-10" data-aos="fade-up">
            <div>
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-navy text-base leading-relaxed">How It Works for Hospitals</h2>
                <p class="text-slate-500 text-sm mt-1 max-w-xl leading-relaxed">
                    Customized management and operational consulting exclusively for the hospital and healthcare sector.
                </p>
            </div>
