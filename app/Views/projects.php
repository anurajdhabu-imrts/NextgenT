        ...
        <div class="flex items-center justify-center text-center" data-aos="fade-up">
            ...
            <div class="max-w-3xl">
                ...
                <p class="text-base md:text-lg text-slate-300 leading-relaxed max-w-2xl mx-auto">
                    A showcase of our impact across hospital infrastructure, NABH accreditation, and medical facility management.
                </p>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div class="bg-white p-6 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow group flex flex-col h-full" data-aos="fade-up" data-aos-delay="100">
                ...
                <h3 class="text-xl font-bold text-navy mb-4">Strategic NABH Accreditation</h3>
                <div class="space-y-3 text-sm flex-grow">
                    <div>
                        <strong class="text-slate-700 block mb-0.5">Problem:</strong>
                        <p class="text-slate-500 leading-relaxed">A secondary-care facility struggled with quality compliance and lacked a structured framework for NABH initial accreditation.</p>
                    </div>
                    <div>
                        <strong class="text-slate-700 block mb-0.5">Solution:</strong>
                        <p class="text-slate-500 leading-relaxed">Implemented 60+ new SOPs, conducted intensive staff sensitization, and overhauled patient safety protocols aligned with gold standards.</p>
                    </div>
                </div>
                <div class="mt-5 pt-4 border-t border-slate-100">
                    <strong class="text-navy text-sm block mb-1">Result:</strong>
                    <p class="text-teal-accent font-semibold text-sm">Successfully achieved NABH accreditation in the first audit with zero major non-conformities.</p>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow group flex flex-col h-full" data-aos="fade-up" data-aos-delay="100">
                ...
                <h3 class="text-xl font-bold text-navy mb-4">Equipment & Layout Planning</h3>
                <div class="space-y-3 text-sm flex-grow">
                    <div>
                        <strong class="text-slate-700 block mb-0.5">Problem:</strong>
                        <p class="text-slate-500 leading-relaxed">A greenfield project required end-to-end medical technology planning and a layout optimized for high-volume patient flow.</p>
                    </div>
                    <div>
                        <strong class="text-slate-700 block mb-0.5">Solution:</strong>
                        <p class="text-slate-500 leading-relaxed">Engineered a clinical-grade architectural layout and handled turnkey equipment procurement with multi-vendor coordination.</p>
                    </div>
                </div>
                <div class="mt-5 pt-4 border-t border-slate-100">
                    <strong class="text-navy text-sm block mb-1">Result:</strong>
                    <p class="text-teal-accent font-semibold text-sm">Reduced capital expenditure by 18% and optimized space utility, increasing bed capacity by 10% in the original footprint.</p>
                </div>
            </div>
