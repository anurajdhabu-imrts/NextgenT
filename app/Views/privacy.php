...
<section class="relative overflow-hidden bg-navy py-16 lg:py-24">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        <span data-aos="fade-up"
            class="inline-block px-4 py-1.5 rounded-full bg-teal-accent/20 border border-teal-accent/30 text-teal-accent text-sm font-bold tracking-widest uppercase mb-6">Legal
            Information</span>
        <h1 data-aos="fade-up" data-aos-delay="100" class="text-4xl md:text-5xl font-bold mb-6">
            <?= esc($settings['privacy_title']) ?></h1>
        <p data-aos="fade-up" data-aos-delay="200" class="text-lg text-slate-300 max-w-2xl mx-auto">
            <?= esc($settings['privacy_intro']) ?>
        </p>
    </div>
</section>
            ...
            <div class="mb-16">
                <div class="space-y-6">
                    ...
                    foreach ($paragraphs as $para):
                        ...
                        // Heading: Matches "1. Title" or "A. Title" or short text without terminal punctuation
                        ...
                        // List Item: Starts with -, *, or bullet
                        ...
                        // Intro/Sub-header: Ends with colon
            ...
            <div class="p-10 bg-slate-50 border border-slate-100 rounded-3xl shadow-sm">
                ...
                <div class="space-y-4">
                    <p class="text-slate-600 leading-relaxed">
                        If you have any questions about this Privacy Policy or our data handling practices, please reach
                        out to us:
                    </p>
