...
<section class="relative overflow-hidden bg-navy">
    <div class="absolute inset-0">
        <img src="<?= esc($hero['image'] ?? 'https://images.unsplash.com/photo-1586773860418-d37222d8fce3?auto=format&fit=crop&w=1600&q=80') ?>"
        ...
        <div class="min-h-[72vh] flex items-center py-16 lg:py-20">
            <div class="max-w-2xl text-white">
                ...
                <h1 data-aos="fade-up" data-aos-delay="200"
                    class="mt-5 text-4xl sm:text-5xl lg:text-5xl font-bold leading-tight">
                    <?= preg_replace('/\*\*(.*?)\*\*/', '<span class="text-teal-accent">$1</span>', esc($hero['title'] ?? '')) ?>
                </h1>

                <p data-aos="fade-up" data-aos-delay="300"
                    class="mt-5 text-base sm:text-lg text-slate-200 leading-7 max-w-xl">
...
<section id="4m-framework" class="py-12 bg-white relative overflow-hidden reveal-on-scroll">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-8" data-aos="fade-up">
            <span
                class="text-teal-accent font-bold tracking-[0.2em] uppercase text-[10px] bg-teal-50 px-3 py-1 rounded-full"><?= esc($framework['subtitle']) ?></span>
            <h2 class="mt-4 text-3xl md:text-4xl lg:text-5xl font-bold text-navy leading-tight">
                <?= esc($framework['title']) ?></h2>
        ...
        <div class="relative flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-10">
            ...
            <div class="lg:hidden grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
                ...
                <div class="p-6 bg-slate-50/80 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
                    <div
                        class="shrink-0 w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center text-navy border border-slate-50">
                ...
                <div class="p-6 bg-slate-50/80 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
                    <div
                        class="shrink-0 w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center text-teal-accent border border-slate-50">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="p-6 bg-slate-50/80 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
                    <div
                        class="shrink-0 w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center text-navy-light border border-slate-50">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="p-6 bg-slate-50/80 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
                    <div
                        class="shrink-0 w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center text-[#0D9488] border border-slate-50">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="hidden lg:flex items-center justify-center w-full max-w-5xl mx-auto py-6">
                ...
                <div class="flex flex-col gap-14 w-[30%]">
                    ...
                    <div class="framework-card group text-right relative cursor-pointer" data-index="0">
                        <div
                            class="inline-flex items-center justify-center w-12 h-12 bg-navy/5 rounded-xl mb-2 text-navy transition-all duration-500 group-hover:bg-navy group-hover:text-white group-hover:-translate-y-1 shadow-sm border border-navy/5">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                            </svg>
                        ...
                        <p class="text-slate-500 text-xs leading-relaxed mt-1.5 max-w-[240px] ml-auto">
                            <?= esc($m1['description']) ?></p>
                        <!-- Thicker Connector -->
                        <div
                            class="absolute -right-6 top-10 w-6 h-[2px] bg-slate-100 group-hover:bg-navy transition-colors duration-500">
                        </div>
                    </div>
                    ...
                    <div class="framework-card group text-right relative cursor-pointer" data-index="2">
                        <div
                            class="inline-flex items-center justify-center w-12 h-12 bg-navy/5 rounded-xl mb-2 text-navy-light transition-all duration-500 group-hover:bg-navy-light group-hover:text-white group-hover:-translate-y-1 shadow-sm border border-navy/5">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                            </svg>
                        ...
                        <p class="text-slate-500 text-xs leading-relaxed mt-1.5 max-w-[240px] ml-auto">
                            <?= esc($m3['description']) ?></p>
                        <!-- Thicker Connector -->
                        <div
                            class="absolute -right-6 top-10 w-6 h-[2px] bg-slate-100 group-hover:bg-navy-light transition-colors duration-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="w-[40%] flex justify-center items-center relative z-10 px-0">
                    <div class="relative w-80 h-80 xl:w-[380px] xl:h-[380px]">
                        ...
                        <svg viewBox="0 0 200 200"
                            class="w-full h-full transform -rotate-90 filter drop-shadow-[0_15px_35px_rgba(15,45,82,0.12)] animate-[spin_120s_linear_infinite] animate-float">
                            <!-- High-precision segments with divider strokes -->
                            <path class="segment transition-all duration-500 cursor-pointer" data-index="0"
                                d="M 100 100 L 100 20 A 80 80 0 0 1 180 100 Z" fill="#0F2D52" stroke="white"
                                stroke-width="2.5" />
                            <path class="segment transition-all duration-500 cursor-pointer" data-index="1"
                                d="M 100 100 L 180 100 A 80 80 0 0 1 100 180 Z" fill="#14B8A6" stroke="white"
                                stroke-width="2.5" />
                            <path class="segment transition-all duration-500 cursor-pointer" data-index="3"
                                d="M 100 100 L 100 180 A 80 80 0 0 1 20 100 Z" fill="#0D9488" stroke="white"
                                stroke-width="2.5" />
                            <path class="segment transition-all duration-500 cursor-pointer" data-index="2"
                                d="M 100 100 L 20 100 A 80 80 0 0 1 100 20 Z" fill="#1A4A7A" stroke="white"
                                stroke-width="2.5" />

                            <!-- Deep Inner Layout -->
                            <circle cx="100" cy="100" r="52" fill="white" />
                            <!-- Animated Inner Decorative Ring -->
                            <circle cx="100" cy="100" r="46" fill="transparent" stroke="#f1f5f9" stroke-width="1"
                                stroke-dasharray="8 4" class="animate-[spin_25s_linear_infinite]" />
                            <circle cx="100" cy="100" r="42" fill="transparent" stroke="rgba(20,184,166,0.1)"
                                stroke-width="1" />
                        </svg>

                        <!-- High-visibility Center Text -->
                        <div
                            class="absolute inset-0 flex flex-col items-center justify-center text-center animate-float">
                            <span class="text-4xl font-black text-navy tracking-tighter leading-none">4M</span>
                            <span
                                class="text-[9px] font-bold uppercase tracking-[0.3em] text-slate-400 mt-2 block">FRAMEWORK</span>
                        </div>
                ...
                <div class="flex flex-col gap-14 w-[30%]">
                    ...
                    <div class="framework-card group text-left relative cursor-pointer" data-index="1">
                        <div
                            class="inline-flex items-center justify-center w-12 h-12 bg-teal-accent/5 rounded-xl mb-2 text-teal-accent transition-all duration-500 group-hover:bg-teal-accent group-hover:text-white group-hover:-translate-y-1 shadow-sm border border-teal-accent/5">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z" />
                            </svg>
                        ...
                        <p class="text-slate-500 text-xs leading-relaxed mt-1.5 max-w-[240px]">
                            <?= esc($m2['description']) ?></p>
                        <!-- Thicker Connector -->
                        <div
                            class="absolute -left-6 top-10 w-6 h-[2px] bg-slate-100 group-hover:bg-teal-accent transition-colors duration-500">
                        </div>
                    </div>
                    ...
                    <div class="framework-card group text-left relative cursor-pointer" data-index="3">
                        <div
                            class="inline-flex items-center justify-center w-12 h-12 bg-teal-accent/5 rounded-xl mb-2 text-[#0D9488] transition-all duration-500 group-hover:bg-[#0D9488] group-hover:text-white group-hover:-translate-y-1 shadow-sm border border-teal-accent/5">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M13 10V3L4 14h7v7l9-11h-7z" />
                            </svg>
                        ...
                        <p class="text-slate-500 text-xs leading-relaxed mt-1.5 max-w-[240px]">
                            <?= esc($m4['description']) ?></p>
                        <!-- Thicker Connector -->
                        <div
                            class="absolute -left-6 top-10 w-6 h-[2px] bg-slate-100 group-hover:bg-[#0D9488] transition-colors duration-500">
                        </div>
                    </div>
                </div>
...
<section id="services" class="bg-white py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="mb-10" data-aos="fade-up">
            <span
                class="text-teal-accent font-bold tracking-[0.2em] uppercase text-[10px] bg-teal-50 px-3 py-1 rounded-full"><?= esc($services_header['subtitle']) ?></span>
        ...
        <div class="flex flex-wrap justify-center gap-8 max-w-7xl mx-auto">
            ...
            <?php foreach ($services as $index => $service): ?>
                ...
                <div data-aos="fade-up" data-aos-delay="<?= $index * 100 ?>"
                    ...
                    <div
                        class="w-25 h-10 flex rounded-lg items-center justify-center mx-auto mb-1 group-hover:bg-navy group-hover:scale-105 transition-all duration-300">
        ...
        <div class="flex flex-col lg:flex-row items-center gap-12 mb-20">
            ...
            <div class="w-full lg:w-1/2" data-aos="fade-right">
                <div class="relative rounded-2xl overflow-hidden shadow-sm border border-slate-100 h-[340px] group">
                    <img src="<?= esc($industries['image'] ?? 'https://aihms.in/blog/wp-content/uploads/2020/04/healthcare3.jpg') ?>"
                        alt="<?= esc($industries['title'] ?? 'Healthcare Industry') ?>"
            ...
            <div class="w-full lg:w-1/2" data-aos="fade-left">
                <div class="space-y-5">
                    <div class="flex items-center gap-2">
                        <span
                            class="text-[10px] font-bold tracking-[0.2em] uppercase text-teal-accent bg-teal-50 px-2 py-1 rounded"><?= esc($industries['subtitle'] ?? 'Industry Focus') ?></span>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <h2 class="text-3xl md:text-4xl font-bold text-navy"> <?= esc($industries['title'] ?? 'Hospital Sector') ?></h2>
                    </div>
                    <p class="text-slate-600 text-base leading-relaxed max-w-xl">
                        <?= esc($industries['description'] ?? 'Delivering operational excellence and strategic growth solutions for modern healthcare institutions, ensuring clinical efficiency and sustainable performance.') ?>
                    </p>
                    ...
                    <div class="pt-2">
                        <a href="/hospital-sector"
                            class="text-teal-accent font-bold text-sm inline-flex items-center group">
                            Explore More
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <?php foreach ($statistics as $index => $stat): ?>
                ...
                <div class="space-y-2" data-aos="fade-up" data-aos-delay="<?= ($index + 1) * 100 ?>">
                    ...
                    <div class="text-4xl md:text-5xl font-bold text-teal-accent leading-none stat-number"
                        data-target="<?= esc($stat['number']) ?>">0</div>
                    <p class="text-xs sm:text-sm font-medium uppercase tracking-widest text-slate-300">
                        <?= esc($stat['label']) ?></p>
                </div>
            <?php endforeach; ?>
            ...
            <?php foreach ($testimonials as $index => $t): ?>
                ...
                <div data-aos="fade-up" data-aos-delay="<?= ($index + 1) * 100 ?>"
                    ...
                    <div class="flex items-center gap-4 mb-5">
                        ...
                        <div>
                            <h3 class="font-bold text-navy text-base leading-tight"><?= esc($t['name']) ?></h3>
